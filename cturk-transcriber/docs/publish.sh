...
#WEB_ROOT=`echo ~/src/cturk-transcriber/wwwroot`
WEB_ROOT="/home/zzz/public_html/cturk-task4/cturk-transcriber/wwwroot";
DOC_ROOT="/home/zzz/public_html/cturk-task4/cturk-transcriber/docs";
