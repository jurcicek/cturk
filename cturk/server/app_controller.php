...
class AppController extends Controller {
	...
	var $SMTP_PORT = '25';
	var $SMTP_TIMEOUT = '30';
	var $SMTP_EMAIL = 'cturk_noreply@zzz.com';
	var $SMTP_USERNAME = 'cturk_noreply';
	var $SMTP_PASSWORD = 'test1234zzz';
	
	var $PAYPAL_APPLICATION_ID = 'APP-2TM1345345345330A';
	var $PAYPAL_API_EMAIL = 'zzz@zzz.com';
	var $PAYPAL_API_USERNAME = 'zzz_api1.zzz.com';
	var $PAYPAL_API_PASSWORD = '82525SDFA25235DF';
	var $PAYPAL_API_SIGNATURE = 'AZFSFS52SMJK.98DDFDF234GCFB34GDG34GDG345GSG344GSF3453Saf';
	var $PAYPAL_API_ENDPOINT = 'https://svcs.paypal.com/';
	var $PAYPAL_REDIRECT_URL = 'https://www.paypal.com/webscr&cmd=';
	

	var $RESET_PASSWORD_LINK = 'http://www.zzz.com/cturk-task4/cturk/client/resetPassword.html';
	var $PAY_RETURN_LINK = 'http://www.zzz.com/cturk-task4/cturk/client/requester/index.html';
